...
public partial class MainWindow : Window
{
    ...
    private void SendTestResult_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        } else if (document.Descendants<Text>().FirstOrDefault(text => text.Text.Contains("Meow")) != null)
        {
            ReplaceTextTestCase("Meow", validationResult, document);
        }
